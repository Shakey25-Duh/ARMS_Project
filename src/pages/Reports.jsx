...
function Reports() {
    ...
    async function viewStudent(student) {
        try {
            ...
            setSelectedSemester(semesters.length > 0 ? semesters[semesters.length - 1] : "");
    ...
    const downloadPDF = () => {
        ...
        infoY += 7;
        doc.text(`Registration No : ${selectedStudent?.registration_no || ""}`, 20, infoY);
        infoY += 7;
                        ...
                        <div className="card-body">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-md-6">
                                    <p><strong>Roll Number:</strong> {selectedStudent.roll_no}</p>
