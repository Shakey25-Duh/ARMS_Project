...
var g = T(Array.prototype.forEach),
  te = T(Array.prototype.lastIndexOf),
  ne = T(Array.prototype.pop),
  _ = T(Array.prototype.push),
  re = T(Array.prototype.splice),
  v = Array.isArray,
  ie = T(String.prototype.toLowerCase),
  ae = T(String.prototype.toString),
  oe = T(String.prototype.match),
  se = T(String.prototype.replace),
  ce = T(String.prototype.indexOf),
  le = T(String.prototype.trim),
  ue = T(Number.prototype.toString),
  de = T(Boolean.prototype.toString),
  y = typeof BigInt > `u` ? null : T(BigInt.prototype.toString),
  b = typeof Symbol > `u` ? null : T(Symbol.prototype.toString),
  x = T(Object.prototype.hasOwnProperty),
  S = T(Object.prototype.toString),
...
var me = d(
  ...
  we = d([`xlink:href`, `xml:id`, `xlink:title`, `xml:space`, `xmlns:xlink`]),
  Te = f(/{{[\w\W]*|^[\w\W]*}}/g),
  Ee = f(/<%[\w\W]*|^[\w\W]*%>/g),
  De = f(/\${[\w\W]*/g),
  Oe = f(/^data-[\-\w.\u00B7-\uFFFF]+$/),
  ...
  je = f(/^(?:\w+script|data):/i),
  Me = f(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
  Ne = f(/^html$/i),
  Pe = f(/^[a-z][.\w]*(-[.\w]+)+$/i),
  Fe = f(/<[/\w!]/g),
  Ie = f(/<[/\w]/g),
  Le = f(/<\/no(script|embed|frames)/i),
  Re = f(/\/>/i),
  j = {
    element: 1,
    attribute: 2,
  ...
  M = function (e, t, n, r) {
    return x(e, t) && v(e[t])
      ? D(r.base ? k(r.base) : {}, e[t], r.transform)
      : n;
  };
function He() {
  let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ze(),
    t = (e) => He(e);
  if (
    ((t.version = `3.4.13`),
    (t.removed = []),
    !e || !e.document || e.document.nodeType !== j.document || !e.Element)
  )
  ...
  let u = e.DOMParser,
    ...
    S = A(h, `shadowRoot`),
    T = A(h, `attributes`),
    E = s && s.prototype ? A(s.prototype, `nodeType`) : null,
    O = s && s.prototype ? A(s.prototype, `nodeName`) : null,
    Ue = s && s.prototype ? A(s.prototype, `ownerDocument`) : null;
  ...
  let N,
    ...
    Xe = n,
    Ze = Xe.implementation,
    Qe = Xe.createNodeIterator,
    $e = Xe.createDocumentFragment,
    et = Xe.getElementsByTagName,
    tt = r.importNode,
    I = Ve();
  t.isSupported =
    typeof o == `function` &&
  ...
  let nt = Te,
    ...
    jt = null,
    Mt = D({}, [`audio`, `video`, `img`, `source`, `image`, `track`]),
    Nt = null,
    Pt = D({}, [
      `alt`,
      `class`,
    ...
    Rt = null,
    zt = D({}, [Ft, It, q], ae),
    Bt = d([`mi`, `mo`, `mn`, `ms`, `mtext`]),
    Vt = D({}, Bt),
    Ht = d([`annotation-xml`]),
    Ut = D({}, Ht),
    Wt = D({}, [`title`, `style`, `font`, `a`, `script`]),
    Gt = null,
    Kt = [`application/xhtml+xml`, `text/html`],
    Y = null,
    X = null,
    qt = n.createElement(`form`),
    Jt = function (e) {
    ...
    Yt = function () {
      ...
      ((!e || typeof e != `object`) && (e = {}),
        (e = k(e)),
        (Gt =
          Kt.indexOf(e.PARSER_MEDIA_TYPE) === -1
            ? `text/html`
            : e.PARSER_MEDIA_TYPE),
        (Y = Gt === `application/xhtml+xml` ? ae : ie),
        (L = M(e, `ALLOWED_TAGS`, dt, { transform: Y })),
        (R = M(e, `ALLOWED_ATTR`, ft, { transform: Y })),
        (Rt = M(e, `ALLOWED_NAMESPACES`, zt, { transform: ae })),
        (Nt = M(e, `ADD_URI_SAFE_ATTR`, Pt, { transform: Y, base: Pt })),
        (jt = M(e, `ADD_DATA_URI_TAGS`, Mt, { transform: Y, base: Mt })),
        (K = M(e, `FORBID_CONTENTS`, At, { transform: Y })),
        (pt = M(e, `FORBID_TAGS`, k({}), { transform: Y })),
        (mt = M(e, `FORBID_ATTR`, k({}), { transform: Y })),
        (G = x(e, `USE_PROFILES`)
          ? e.USE_PROFILES && typeof e.USE_PROFILES == `object`
            ? k(e.USE_PROFILES)
            : e.USE_PROFILES
          : !1),
        (ht = e.ALLOW_ARIA_ATTR !== !1),
        (gt = e.ALLOW_DATA_ATTR !== !1),
        (_t = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
        (vt = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
        (V = e.SAFE_FOR_TEMPLATES || !1),
        (H = e.SAFE_FOR_XML !== !1),
        (U = e.WHOLE_DOCUMENT || !1),
        (W = e.RETURN_DOM || !1),
        (Ct = e.RETURN_DOM_FRAGMENT || !1),
        (wt = e.RETURN_TRUSTED_TYPE || !1),
        (St = e.FORCE_BODY || !1),
        (Tt = e.SANITIZE_DOM !== !1),
        (Et = e.SANITIZE_NAMED_PROPS || !1),
        (Ot = e.KEEP_CONTENT !== !1),
        (kt = e.IN_PLACE || !1),
        (ut = pe(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : Ae),
        (J = typeof e.NAMESPACE == `string` ? e.NAMESPACE : q),
        (Vt =
          x(e, `MATHML_TEXT_INTEGRATION_POINTS`) &&
          e.MATHML_TEXT_INTEGRATION_POINTS &&
          typeof e.MATHML_TEXT_INTEGRATION_POINTS == `object`
            ? k(e.MATHML_TEXT_INTEGRATION_POINTS)
            : D({}, Bt)),
        (Ut =
          x(e, `HTML_INTEGRATION_POINTS`) &&
          e.HTML_INTEGRATION_POINTS &&
          typeof e.HTML_INTEGRATION_POINTS == `object`
            ? k(e.HTML_INTEGRATION_POINTS)
            : D({}, Ht)));
      let t =
      ...
      if (
        ...
        x(t, `tagNameCheck`) &&
          Jt(t.tagNameCheck) &&
          (z.tagNameCheck = t.tagNameCheck),
        x(t, `attributeNameCheck`) &&
          Jt(t.attributeNameCheck) &&
          (z.attributeNameCheck = t.attributeNameCheck),
        x(t, `allowCustomizedBuiltInElements`) &&
        ...
        G &&
          ((L = D({}, be)),
          (R = p(null)),
          G.html === !0 && (D(L, me), D(R, xe)),
          G.svg === !0 && (D(L, he), D(R, Se), D(R, we)),
          G.svgFilters === !0 && (D(L, ge), D(R, Se), D(R, we)),
          G.mathMl === !0 && (D(L, ve), D(R, Ce), D(R, we))),
        (B.tagCheck = null),
        (B.attributeCheck = null),
        x(e, `ADD_TAGS`) &&
          (typeof e.ADD_TAGS == `function`
            ? (B.tagCheck = e.ADD_TAGS)
            : v(e.ADD_TAGS) && (L === dt && (L = k(L)), D(L, e.ADD_TAGS, Y))),
        x(e, `ADD_ATTR`) &&
          (typeof e.ADD_ATTR == `function`
            ? (B.attributeCheck = e.ADD_ATTR)
            : v(e.ADD_ATTR) && (R === ft && (R = k(R)), D(R, e.ADD_ATTR, Y))),
        x(e, `ADD_URI_SAFE_ATTR`) &&
          v(e.ADD_URI_SAFE_ATTR) &&
          D(Nt, e.ADD_URI_SAFE_ATTR, Y),
        x(e, `FORBID_CONTENTS`) &&
          v(e.FORBID_CONTENTS) &&
          (K === At && (K = k(K)), D(K, e.FORBID_CONTENTS, Y)),
        x(e, `ADD_FORBID_CONTENTS`) &&
          v(e.ADD_FORBID_CONTENTS) &&
          (K === At && (K = k(K)), D(K, e.ADD_FORBID_CONTENTS, Y)),
        Ot && (L[`#text`] = !0),
        U && D(L, [`html`, `head`, `body`]),
        L.table && (D(L, [`tbody`]), delete pt.tbody),
        ...
        e.TRUSTED_TYPES_POLICY === null
          ? ((N = void 0), (P = ``))
          : (N === void 0 && (N = Ye()),
            N && typeof P == `string` && (P = F(``)));
      (d && d(e), (X = e));
    },
    Xt = D({}, [...he, ...ge, ..._e]),
    Zt = D({}, [...ve, ...ye]),
    Qt = function (e, t, n) {
      return t.namespaceURI === q
        ? e === `svg`
        : t.namespaceURI === Ft
          ? e === `svg` && (n === `annotation-xml` || Vt[n])
          : !!Xt[e];
    },
    $t = function (e, t, n) {
      return t.namespaceURI === q
    ...
    en = function (e, t, n) {
      return (t.namespaceURI === It && !Ut[n]) ||
        (t.namespaceURI === Ft && !Vt[n])
        ? !1
        : !Zt[e] && (Wt[e] || !Xt[e]);
    },
    tn = function (e) {
      ...
      return Rt[e.namespaceURI]
        ? e.namespaceURI === It
          ...
          : e.namespaceURI === Ft
            ...
            : e.namespaceURI === q
              ? en(n, t, r)
              : !!(Gt === `application/xhtml+xml` && Rt[e.namespaceURI])
        : !1;
    },
    Z = function (e) {
    ...
    Q = function (e, n) {
      try {
        _(t.removed, { attribute: n.getAttributeNode(e), from: n });
      } catch {
        _(t.removed, { attribute: null, from: n });
      }
    ...
    on = function (e) {
      ...
      for (; t.length > 0;) {
        let e = t.pop(),
          n = E ? E(e) : e.nodeType;
        if (
          n === j.processingInstruction ||
          (n === j.comment && C(Ie, e.data))
        ) {
          try {
            ue(e);
          } catch {}
    ...
    sn = function (e) {
      ...
      return (
        ...
        J === q ? et.call(t, U ? `html` : `body`)[0] : U ? t.documentElement : a
      );
    },
    cn = function (e) {
    ...
    dn = function (e) {
      let t = O ? O(e) : null;
      return typeof t != `string` || Y(t) !== `form`
        ? !1
  ...
  let mn = function (e, t) {
      return !!(
        ...
        (H &&
          ...
          t === `style` &&
          pn(e.firstElementChild)) ||
        e.nodeType === j.processingInstruction ||
        (H && e.nodeType === j.comment && C(Ie, e.data))
      );
    },
    hn = function (e, t, n) {
      if (
        !pt[t] &&
        bn(t) &&
        ((z.tagNameCheck instanceof RegExp && C(z.tagNameCheck, t)) ||
          (z.tagNameCheck instanceof Function && z.tagNameCheck(t)))
      )
        return !1;
      if (Ot && !K[t]) {
        let t = b(e),
    ...
    _n = function (e, n) {
      if (($(I.beforeSanitizeElements, e, null), e !== n && b(e) === null))
        return (kt && an(e), !0);
      if (dn(e)) return (Z(e), !0);
      let r = Y(O ? O(e) : e.nodeName);
      if (
        ((L = gn(I.uponSanitizeElement, L, dt, bt)),
        $(I.uponSanitizeElement, e, { tagName: r, allowedTags: L }),
        e !== n && b(e) === null)
      )
        return (kt && an(e), !0);
      ...
      if (
        pt[r] ||
        (!(B.tagCheck instanceof Function && B.tagCheck(r)) && !L[r])
      ) {
        let t = hn(e, r, n);
        return (t === !1 && $(I.afterSanitizeElements, e, null), t);
      }
      if (
        ((E ? E(e) : e.nodeType) === j.element && !tn(e)) ||
      ...
      if (V && e.nodeType === j.text) {
        ...
        e.textContent !== n &&
          (_(t.removed, { element: e.cloneNode() }), (e.textContent = n));
      }
    ...
    vn = function (e, t, r) {
      if (
        mt[t] ||
        (H && t === `patchsrc`) ||
        (H && t === `for` && e !== `label` && e !== `output`) ||
        (Tt && (t === `id` || t === `name`) && (r in n || r in qt))
      )
        return !1;
      let i =
        R[t] ||
        (B.attributeCheck instanceof Function && B.attributeCheck(t, e));
      if (!(gt && C(at, t)) && !(ht && C(ot, t))) {
        if (!i) {
          if (!(
            (bn(e) &&
              ((z.tagNameCheck instanceof RegExp && C(z.tagNameCheck, e)) ||
                (z.tagNameCheck instanceof Function && z.tagNameCheck(e))) &&
              ((z.attributeNameCheck instanceof RegExp &&
                C(z.attributeNameCheck, t)) ||
                (z.attributeNameCheck instanceof Function &&
                  z.attributeNameCheck(t, e)))) ||
            (t === `is` &&
              z.allowCustomizedBuiltInElements &&
              ((z.tagNameCheck instanceof RegExp && C(z.tagNameCheck, r)) ||
                (z.tagNameCheck instanceof Function && z.tagNameCheck(r))))
          ))
            return !1;
        } else if (
          !Nt[t] &&
    ...
    wn = function (e) {
      ...
      for ($(I.beforeSanitizeShadowDOM, e, null); (t = n.nextNode());)
        if (
          ($(I.uponSanitizeShadowNode, t, null),
          _n(t, e),
          Cn(t),
          fn(t.content) && wn(t.content),
          (E ? E(t) : t.nodeType) === j.element)
        ) {
          let e = S(t);
          fn(e) && (Tn(e), wn(e));
        }
      ...
      for (; t.length > 0;) {
        ...
        if (r) {
          ...
          if (typeof e == `string` && Y(e) === `template`) {
            let e = n.content;
            fn(e) && t.push({ node: e, shadow: null });
          }
        }
        if (r) {
          let e = S(n);
          fn(e) && t.push({ node: null, shadow: e }, { node: e, shadow: null });
        }
      }
    };
  return (
    (t.sanitize = function (e) {
      ...
      if (
        ((Lt = !e),
        Lt && (e = `<!-->`),
        typeof e != `string` && !pn(e) && ((e = fe(e)), typeof e != `string`))
      )
        throw w(`dirty is not a string, aborting`);
      if (!t.isSupported) return e;
      (yt ? ((L = bt), (R = xt)) : Yt(n),
        (I.uponSanitizeElement.length > 0 ||
          I.uponSanitizeAttribute.length > 0) &&
          (L = k(L)),
        I.uponSanitizeAttribute.length > 0 && (R = k(R)),
        (t.removed = []));
      ...
      if (c) {
        ...
        if (typeof t == `string`) {
          ...
          if (!L[n] || pt[n])
            throw (
              nn(e),
              w(`root node is forbidden and cannot be sanitized in-place`)
            );
        }
        if (dn(e))
          throw (
            nn(e),
            w(`root node is clobbered and cannot be sanitized in-place`)
          );
        try {
          Tn(e);
        } catch (t) {
        ...
        ((i = sn(`<!---->`)),
          ...
          (a.nodeType === j.element && a.nodeName === `BODY`) ||
          a.nodeName === `HTML`
            ? (i = a)
            : i.appendChild(a),
          Tn(a));
      ...
      try {
        let e = cn(l);
        for (; (o = e.nextNode());)
          (_n(o, l), Cn(o), fn(o.content) && wn(o.content));
      } catch (n) {
        throw (
          c &&
            (nn(e),
      ...
      if (W) {
        if ((V && un(i), Ct))
          for (s = $e.call(i.ownerDocument); i.firstChild;)
            s.appendChild(i.firstChild);
        else s = i;
        return (
          (R.shadowroot || R.shadowrootmode) && (s = tt.call(r, s, !0)),
          s
        );
      }
      ...
      return (
        U &&
          ...
          C(Ne, i.ownerDocument.doctype.name) &&
          (u =
            `<!DOCTYPE ` +
            i.ownerDocument.doctype.name +
            `>
