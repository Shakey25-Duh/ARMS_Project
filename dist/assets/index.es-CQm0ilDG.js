import { n as e, r as t, t as n } from "./index-CYa_C33l.js";
var r = e((e, t) => {
    var n = function (e) {
  ...
  L = e((e, t) => {
    ...
    t.exports = function (e, t) {
      ...
      var s = a(e, u),
        c;
      if (s) {
        if ((t === void 0 && (t = `default`), (c = n(s, e, t)), !r(c) || i(c)))
          return c;
  ...
  ue = e((e, t) => {
    ...
    t.exports = { set: m, get: h, has: g, enforce: v, getterFor: y };
  }),
  de = e((e, t) => {
    var n = u(),
      r = i(),
      ...
      C = (t.exports = function (e, t, n) {
        (v(h(t), 0, 7) === `Symbol(` &&
          (t = `[` + y(h(t), /^Symbol\(([^)]*)\).*$/, `$1`) + `]`),
          n && n.getter && (t = `get ` + t),
          n && n.setter && (t = `set ` + t),
          (!s(e, `name`) || (l && e.name !== t)) &&
            (c ? _(e, `name`, { value: t, configurable: !0 }) : (e.name = t)),
          x &&
            n &&
            s(n, `arity`) &&
            e.length !== n.arity &&
            _(e, `length`, { value: n.arity }));
        try {
          n && s(n, `constructor`) && n.constructor
            ? c && _(e, `prototype`, { writable: !1 })
            : (e.prototype &&= void 0);
        } catch {}
        var r = p(e);
        return (
          s(r, `source`) || (r.source = b(S, typeof t == `string` ? t : ``)),
          e
        );
      });
  ...
  U = e((e, t) => {
    ...
    t.exports = function (e, t) {
      var r = e.target,
        ...
        d = e.stat,
        f,
        p = u ? n : d ? n[r] || s(r, {}) : n[r] && n[r].prototype,
        m,
        h,
        g,
        _;
      if (p)
        for (m in t) {
          if (
            ((g = t[m]),
            e.dontCallGetSet ? ((_ = i(p, m)), (h = _ && _.value)) : (h = p[m]),
            (f = l(u ? m : r + (d ? `.` : `#`) + m, e.forced)),
            !f && h !== void 0)
          ) {
    ...
    t.exports = n
      ...
      : function (e) {
          ...
          return e === void 0
            ...
            : e === null
              ? `Null`
              : typeof (n = c((t = o(e)), a)) == `string`
                ? n
                : s
                  ? i(t)
                  : (l = i(t)) === `Object` && r(t.callee)
                    ? `Arguments`
                    : l;
        };
  }),
        ...
        : b && b.now
          ...
          : S && !m
            ...
            : n.addEventListener &&
                ...
                D.protocol !== `file:` &&
                !l(F)
              ? ((O = F), n.addEventListener(`message`, N, !1))
              : (O =
                  E in f(`script`)
                    ? function (e) {
  ...
  Ze = e((e, t) => {
    ...
    if (!g) {
      var S = new s(),
        C = function () {
          var e, t;
          for (d && (e = m.domain) && e.exit(); (t = S.get());)
            try {
              t();
            } catch (e) {
              throw (S.head && _(), e);
      ...
      (!c && !d && !u && f && p
        ? ((v = !0),
          (y = p.createTextNode(``)),
          new f(C).observe(y, { characterData: !0 }),
          (_ = function () {
            y.data = v = !v;
          }))
        : !l && h && h.resolve
      ...
      CONSTRUCTOR: o(`Promise`, function () {
        ...
        if (!d || d < 51 || !/native code/.test(e)) {
          var n = new i(function (e) {
            ...
            a = (n.constructor = {});
          if (((a[p] = r), (m = n.then(function () {}) instanceof r), !m))
            return !0;
        }
  ...
  rt = e(() => {
    var e = U(),
      ...
      ne = O.f,
      B = ne,
      re = !!(ee && ee.createEvent && i.dispatchEvent),
      ...
      _e = function (e, t) {
        ...
        try {
          i
            ? (r || (t.rejection === de && xe(t), (t.rejection = le)),
              i === !0
                ? (l = n)
                : (c && c.enter(), (l = i(n)), c && (c.exit(), (d = !0))),
              l === e.promise
                ? s(new z(`Promise-chain cycle`))
                : (u = ge(l))
                  ? o(u, l, a, s)
                  : a(l))
            : s(n);
      ...
      ve = function (e, t, n) {
        ...
        (re
          ...
          !M && (a = i[`on` + e])
            ? a(r)
            : e === ie && x(`Unhandled promise rejection`, n));
      },
      ye = function (e) {
        o(y, i, function () {
          var t = e.facade,
    ...
    (e({ global: !0, constructor: !0, wrap: !0, forced: j }, { Promise: L }),
      (he = a.Promise),
      u(L, A, !1, !0),
      d(A));
  }),
  ...
  ft = e(() => {
    var e = U(),
      ...
      a = lt();
    e(
      { target: `Promise`, stat: !0, forced: dt() },
      {
        all: function (e) {
          var o = this,
            s = r.f(o),
  ...
  wt = e((e) => {
    ...
    e.f =
      t && !n
        ...
        : function (e, t) {
            i(e);
            for (var n = o(t), a = s(t), c = a.length, l = 0, u; c > l;)
              r.f(e, (u = a[l++]), n[u]);
            return e;
          };
  }),
...
` &&
        ...
        return (
          p
            ? A
              ...
              : (t.lastIndex = 0)
            : x && A && (t.lastIndex = t.global ? A.index + A[0].length : u),
          C &&
            A &&
            A.length > 1 &&
            n(m, A[0], l, function () {
              for (var e = 1; e < arguments.length - 2; e++)
                arguments[e] === void 0 && (A[e] = void 0);
            }),
          A && f && T(A, f),
          A
        );
  ...
  kt = e(() => {
    var e = U(),
      t = Ot();
    e({ target: `RegExp`, proto: !0, forced: /./.exec !== t }, { exec: t });
  }),
  At = e((e, t) => {
    kt();
    var n = s(),
    ...
    t.exports = function (e, t, i, s) {
      ...
      if (!p || !m || i) {
        var h = /./[f],
          g = t(f, ``[e], function (e, t, r, i, o) {
            var s = t.exec;
            return s === a || s === d.exec
              ? p && !o
                ? { done: !0, value: n(h, t, r, i) }
                : { done: !0, value: n(e, r, t, i) }
              : { done: !1 };
          });
      ...
      return [
        ...
        function (e) {
          ...
          for (var m = [], g = 0, _; (_ = p(t, i)) !== null;) {
            var v = o(_[0]);
            ((m[g] = v),
              v === `` && (t.lastIndex = d(i, a(t.lastIndex), u)),
              g++);
          }
          return g === 0 ? null : m;
        },
      ...
      function (n, r, i) {
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var y = [], C; (C = S(s, l)), !(C === null || (O(y, C), !g));)
              p(C[0]) === `` && (s.lastIndex = v(l, f(s.lastIndex), _));
            for (var D = ``, M = 0, N = 0; N < y.length; N++) {
              C = y[N];
              for (
                var P = p(C[0]),
                  F = w(T(d(C.index), l.length), 0),
                  I = [],
                  L,
                  R = 1;
                R < C.length;
    ...
    e(
      ...
      },
      {
        startsWith: function (e) {
          ...
          a(e);
          var n = i(e),
            s = r(u(arguments.length > 1 ? arguments[1] : void 0, t.length));
  ...
  Ut = e((e, t) => {
    var n = I(),
      ...
      a = n(`unscopables`),
      o = Array.prototype;
    (o[a] === void 0 && i(o, a, { configurable: !0, value: r(null) }),
      (t.exports = function (e) {
        o[a][e] = !0;
      }));
  }),
  ...
  Kt = e((e, t) => {
    ...
    ([].keys &&
      ((h = [].keys()),
      `next` in h
        ? ((m = s(s(h))), m !== Object.prototype && (p = m))
        : (f = !0)),
      !a(p) ||
      n(function () {
        var e = {};
      ...
      (t.exports = { IteratorPrototype: p, BUGGY_SAFARI_ITERATORS: f }));
  }),
  qt = e((e, t) => {
    var n = Kt().IteratorPrototype,
      r = Tt(),
      i = l(),
      a = je(),
      o = it(),
  ...
  Jt = e((e, t) => {
    ...
    t.exports = function (e, t, a, s, m, g, _) {
      ...
      if (
        ...
        if (((F = { values: D(w), keys: g ? M : D(C), entries: D(T) }), _))
          for (I in F) (x || k || !(I in A)) && p(A, I, F[I]);
        else n({ target: t, proto: !0, forced: x || k }, F);
      return (
        (!i || _) && A[S] !== M && p(A, S, M, { name: m }),
        (h[t] = M),
        F
      );
    };
  ...
  Xt = e((e, t) => {
    ...
    if ((r(`keys`), r(`values`), r(`entries`), !u && d && g.name !== `values`))
      try {
...
var rn = e((e, t) => {
        ...
        return [
          ...
          function (e, t) {
            ...
            for (var E = 0, D = 0, k = []; D < o.length;) {
              ...
              if (
                A === null ||
                (j = S(d(v.lastIndex + (b ? D : 0)), o.length)) === E
              )
                D = l(o, D, _);
              else {
                if ((C(k, w(o, E, D)), k.length === y)) return k;
                for (var M = 1; M <= A.length - 1; M++)
                  if ((C(k, A[M]), k.length === y)) return k;
                D = E = j;
              }
            }
            return (C(k, w(o, E)), k);
  ...
  un = e((e, t) => {
    for (
      var n = ln(),
        r = typeof window > `u` ? global : window,
        i = [`moz`, `webkit`],
        a = `AnimationFrame`,
        o = r[`request` + a],
    ...
    if (!o || !s) {
      ...
      ((o = function (e) {
        ...
        return (d.push({ handle: ++u, callback: e, cancelled: !1 }), u);
      }),
        (s = function (e) {
...
\v\f\r \xA0              　\u2028\u2029﻿`;
  ...
  mn = e(() => {
    var e = U(),
      t = fn().trim;
    e(
      { target: `String`, proto: !0, forced: pn()(`trim`) },
      {
        trim: function () {
          return t(this);
        },
...
function wn(e) {
  ...
  for (var n = 0; n < e.length; n++) {
    ...
    else if (r.type === K.MOVE_TO)
      t += (r.relative ? `m` : `M`) + r.x + ` ` + r.y;
    else if (r.type === K.LINE_TO)
      t += (r.relative ? `l` : `L`) + r.x + ` ` + r.y;
    else if (r.type === K.CURVE_TO)
      t +=
        (r.relative ? `c` : `C`) +
        r.x1 +
        ` ` +
        ...
        ` ` +
        r.y;
    else if (r.type === K.SMOOTH_CURVE_TO)
      t += (r.relative ? `s` : `S`) + r.x2 + ` ` + r.y2 + ` ` + r.x + ` ` + r.y;
    else if (r.type === K.QUAD_TO)
      t += (r.relative ? `q` : `Q`) + r.x1 + ` ` + r.y1 + ` ` + r.x + ` ` + r.y;
    else if (r.type === K.SMOOTH_QUAD_TO)
      t += (r.relative ? `t` : `T`) + r.x + ` ` + r.y;
    else {
      if (r.type !== K.ARC)
        throw Error(
          `Unexpected command type "` + r.type + `" at index ` + n + `.`,
        );
      t +=
        (r.relative ? `a` : `A`) +
        r.rX +
...
var Dn = Math.PI;
function On(e, t, n) {
  ((e.lArcFlag = e.lArcFlag === 0 ? 0 : 1),
    (e.sweepFlag = e.sweepFlag === 0 ? 0 : 1));
  var r = e.rX,
    i = e.rY,
    a = e.x,
    o = e.y;
  ((r = Math.abs(e.rX)), (i = Math.abs(e.rY)));
  var s = Tn([(t - a) / 2, (n - o) / 2], (-e.xRot / 180) * Dn),
    c = s[0],
    l = s[1],
    u = c ** 2 / r ** 2 + l ** 2 / i ** 2;
  (1 < u && ((r *= Math.sqrt(u)), (i *= Math.sqrt(u))), (e.rX = r), (e.rY = i));
  var d = r ** 2 * l ** 2 + i ** 2 * c ** 2,
    f =
      (e.lArcFlag === e.sweepFlag ? -1 : 1) *
      Math.sqrt(Math.max(0, (r ** 2 * i ** 2 - d) / d)),
    p = ((r * l) / i) * f,
    m = ((-i * c) / r) * f,
    h = Tn([p, m], (e.xRot / 180) * Dn);
  ((e.cX = h[0] + (t + a) / 2),
    (e.cY = h[1] + (n + o) / 2),
    (e.phi1 = Math.atan2((l - m) / i, (c - p) / r)),
    (e.phi2 = Math.atan2((-l - m) / i, (-c - p) / r)),
    e.sweepFlag === 0 && e.phi2 > e.phi1 && (e.phi2 -= 2 * Dn),
    e.sweepFlag === 1 && e.phi2 < e.phi1 && (e.phi2 += 2 * Dn),
    (e.phi1 *= 180 / Dn),
    (e.phi2 *= 180 / Dn));
}
function kn(e, t, n) {
  ...
  var i = Math.sqrt(r);
  return [
    [(e * n + t * i) / (e * e + t * t), (t * n - e * i) / (e * e + t * t)],
    [(e * n - t * i) / (e * e + t * t), (t * n + e * i) / (e * e + t * t)],
  ];
}
var G,
...
(function (e) {
  ...
  function n() {
    ...
    return i(function (i, a, o) {
      return (
        i.type & K.SMOOTH_CURVE_TO &&
          ((i.type = K.CURVE_TO),
          (e = isNaN(e) ? a : e),
          (t = isNaN(t) ? o : t),
          (i.x1 = i.relative ? a - e : 2 * a - e),
          (i.y1 = i.relative ? o - t : 2 * o - t)),
        i.type & K.CURVE_TO
          ? ((e = i.relative ? a + i.x2 : i.x2),
            (t = i.relative ? o + i.y2 : i.y2))
          : ((e = NaN), (t = NaN)),
        i.type & K.SMOOTH_QUAD_TO &&
          ((i.type = K.QUAD_TO),
          (n = isNaN(n) ? a : n),
          (r = isNaN(r) ? o : r),
          (i.x1 = i.relative ? a - n : 2 * a - n),
          (i.y1 = i.relative ? o - r : 2 * o - r)),
        i.type & K.QUAD_TO
          ? ((n = i.relative ? a + i.x1 : i.x1),
            (r = i.relative ? o + i.y1 : i.y1))
          : ((n = NaN), (r = NaN)),
        i
      );
    });
  ...
  function r() {
    ...
    return i(function (n, r, i) {
      if (
        (n.type & K.SMOOTH_QUAD_TO &&
          ((n.type = K.QUAD_TO),
          (e = isNaN(e) ? r : e),
          (t = isNaN(t) ? i : t),
          (n.x1 = n.relative ? r - e : 2 * r - e),
          (n.y1 = n.relative ? i - t : 2 * i - t)),
        n.type & K.QUAD_TO)
      ) {
        ((e = n.relative ? r + n.x1 : n.x1),
          (t = n.relative ? i + n.y1 : n.y1));
        var a = n.x1,
          o = n.y1;
        ((n.type = K.CURVE_TO),
          (n.x1 = ((n.relative ? 0 : r) + 2 * a) / 3),
          (n.y1 = ((n.relative ? 0 : i) + 2 * o) / 3),
          (n.x2 = (n.x + 2 * a) / 3),
          (n.y2 = (n.y + 2 * o) / 3));
      } else ((e = NaN), (t = NaN));
      return n;
  ...
  function i(e) {
    var t = 0,
      ...
      i = NaN;
    return function (a) {
      if (isNaN(r) && !(a.type & K.MOVE_TO))
        throw Error(`path must start with moveto`);
      var o = e(a, t, n, r, i);
      return (
        a.type & K.CLOSE_PATH && ((t = r), (n = i)),
        a.x !== void 0 && (t = a.relative ? t + a.x : a.x),
        a.y !== void 0 && (n = a.relative ? n + a.y : a.y),
        a.type & K.MOVE_TO && ((r = t), (i = n)),
        o
      );
    };
  }
  function a(e, t, n, r, a, o) {
    return (
      ...
      i(function (i, s, c, l) {
        var u = i.x1,
          d = i.x2,
          f = i.relative && !isNaN(l),
          p = i.x === void 0 ? (f ? 0 : s) : i.x,
          m = i.y === void 0 ? (f ? 0 : c) : i.y;
        function h(e) {
          return e * e;
        }
        (i.type & K.HORIZ_LINE_TO &&
          t !== 0 &&
          ((i.type = K.LINE_TO), (i.y = i.relative ? 0 : c)),
          i.type & K.VERT_LINE_TO &&
            n !== 0 &&
            ((i.type = K.LINE_TO), (i.x = i.relative ? 0 : s)),
          i.x !== void 0 && (i.x = i.x * e + m * n + (f ? 0 : a)),
          i.y !== void 0 && (i.y = p * t + i.y * r + (f ? 0 : o)),
          i.x1 !== void 0 && (i.x1 = i.x1 * e + i.y1 * n + (f ? 0 : a)),
          i.y1 !== void 0 && (i.y1 = u * t + i.y1 * r + (f ? 0 : o)),
          i.x2 !== void 0 && (i.x2 = i.x2 * e + i.y2 * n + (f ? 0 : a)),
          i.y2 !== void 0 && (i.y2 = d * t + i.y2 * r + (f ? 0 : o)));
        var g = e * r - t * n;
        if (i.xRot !== void 0 && (e !== 1 || t !== 0 || n !== 0 || r !== 1))
          if (g === 0)
            ...
            var _ = (i.xRot * Math.PI) / 180,
              ...
              w = h(v) * b + h(y) * x,
              T = S * r * r - C * t * r + w * t * t,
              E = C * (e * r + t * n) - 2 * (S * n * r + w * e * t),
              D = S * n * n - C * e * n + w * e * e,
              O = ((Math.atan2(E, T - D) + Math.PI) % Math.PI) / 2,
              k = Math.sin(O),
              A = Math.cos(O);
            ((i.rX = Math.abs(g) / Math.sqrt(T * h(A) + E * k * A + D * h(k))),
              (i.rY = Math.abs(g) / Math.sqrt(T * h(k) - E * k * A + D * h(A))),
              (i.xRot = (180 * O) / Math.PI));
          }
        return (
          i.sweepFlag !== void 0 && 0 > g && (i.sweepFlag = +!i.sweepFlag),
          i
        );
      })
    );
  ...
  ((e.ROUND = function (e) {
    ...
    return (
      e === void 0 && (e = 0x9184e72a000),
      En(e),
      function (e) {
        return (
          e.x1 !== void 0 && (e.x1 = t(e.x1)),
          e.y1 !== void 0 && (e.y1 = t(e.y1)),
          e.x2 !== void 0 && (e.x2 = t(e.x2)),
          e.y2 !== void 0 && (e.y2 = t(e.y2)),
          e.x !== void 0 && (e.x = t(e.x)),
          e.y !== void 0 && (e.y = t(e.y)),
          e.rX !== void 0 && (e.rX = t(e.rX)),
          e.rY !== void 0 && (e.rY = t(e.rY)),
          e
        );
      }
    );
    ...
    (e.NORMALIZE_HVZ = function (e, t, n) {
      return (
        ...
        t === void 0 && (t = !0),
        n === void 0 && (n = !0),
        i(function (r, i, a, o, s) {
          if (isNaN(o) && !(r.type & K.MOVE_TO))
            throw Error(`path must start with moveto`);
          return (
            t &&
              r.type & K.HORIZ_LINE_TO &&
              ((r.type = K.LINE_TO), (r.y = r.relative ? 0 : a)),
            n &&
              r.type & K.VERT_LINE_TO &&
              ((r.type = K.LINE_TO), (r.x = r.relative ? 0 : i)),
            e &&
              r.type & K.CLOSE_PATH &&
              ((r.type = K.LINE_TO),
              (r.x = r.relative ? o - i : o),
              (r.y = r.relative ? s - a : s)),
            r.type & K.ARC &&
              (r.rX === 0 || r.rY === 0) &&
              ((r.type = K.LINE_TO),
              delete r.rX,
    ...
    (e.SANITIZE = function (e) {
      ...
      return i(function (i, o, s, c, l) {
        ...
        if (
          (i.type & K.SMOOTH_CURVE_TO &&
            ((f = isNaN(t) ? 0 : o - t), (p = isNaN(n) ? 0 : s - n)),
          i.type & (K.CURVE_TO | K.SMOOTH_CURVE_TO)
            ? ((t = i.relative ? o + i.x2 : i.x2),
              (n = i.relative ? s + i.y2 : i.y2))
            : ((t = NaN), (n = NaN)),
          i.type & K.SMOOTH_QUAD_TO
            ? ((r = isNaN(r) ? o : 2 * o - r), (a = isNaN(a) ? s : 2 * s - a))
            : i.type & K.QUAD_TO
              ? ((r = i.relative ? o + i.x1 : i.x1),
                (a = i.relative ? s + i.y1 : i.y2))
              : ((r = NaN), (a = NaN)),
          i.type & K.LINE_COMMANDS ||
            (i.type & K.ARC && (i.rX === 0 || i.rY === 0 || !i.lArcFlag)) ||
            i.type & K.CURVE_TO ||
            i.type & K.SMOOTH_CURVE_TO ||
            i.type & K.QUAD_TO ||
            i.type & K.SMOOTH_QUAD_TO)
        ) {
          var m = i.x === void 0 ? 0 : i.relative ? i.x : i.x - o,
            h = i.y === void 0 ? 0 : i.relative ? i.y : i.y - s;
          ((f = isNaN(r)
            ? i.x1 === void 0
              ? f
              : i.relative
            ...
            (p = isNaN(a)
              ? i.y1 === void 0
                ...
                : i.relative
                  ...
                  : i.y1 - s
              : a - s));
          var g = i.x2 === void 0 ? 0 : i.relative ? i.x : i.x2 - o,
            _ = i.y2 === void 0 ? 0 : i.relative ? i.y : i.y2 - s;
          u(m) <= e &&
            u(h) <= e &&
            u(f) <= e &&
            u(p) <= e &&
        ...
        return (
          i.type & K.CLOSE_PATH && u(o - c) <= e && u(s - l) <= e && (d = !0),
          d ? [] : i
        );
      });
    }),
      ...
      return i(function (e, t, n) {
        return K.ARC === e.type
          ? (function (e, t, n) {
              ...
              e.cX || On(e, t, n);
              for (
                var s = Math.min(e.phi1, e.phi2),
                  c = Math.max(e.phi1, e.phi2) - s,
                  l = Math.ceil(c / 90),
                  u = Array(l),
                  d = t,
                  f = n,
                ...
                var m = jn(e.phi1, e.phi2, p / l),
                  h = jn(e.phi1, e.phi2, (p + 1) / l),
                  g = h - m,
                  _ = (4 / 3) * Math.tan((g * An) / 4),
                  v = [
                    Math.cos(m * An) - _ * Math.sin(m * An),
                    Math.sin(m * An) + _ * Math.cos(m * An),
                  ],
                  y = v[0],
                  b = v[1],
                  x = [Math.cos(h * An), Math.sin(h * An)],
                  S = x[0],
                  C = x[1],
                  w = [S + _ * Math.sin(h * An), C - _ * Math.cos(h * An)],
                  T = w[0],
                  E = w[1];
                u[p] = { relative: e.relative, type: K.CURVE_TO };
                var D = function (t, n) {
                  var r = Tn([t * e.rX, n * e.rY], e.xRot),
                    i = r[0],
                    a = r[1];
              ...
              return u;
            })(e, e.relative ? 0 : t, e.relative ? 0 : n)
          : e;
      });
    }),
    ...
    (e.CALCULATE_BOUNDS = function () {
      var e = function (e) {
        ...
        c = i(function (t, n, r) {
          ...
          if (
            (i.type & K.DRAWING_COMMANDS && (l(n), u(r)),
            i.type & K.HORIZ_LINE_TO && l(i.x),
            i.type & K.VERT_LINE_TO && u(i.y),
            i.type & K.LINE_TO && (l(i.x), u(i.y)),
            i.type & K.CURVE_TO)
          ) {
            (l(i.x), u(i.y));
            for (var d = 0, f = Nn(n, i.x1, i.x2, i.x); d < f.length; d++)
              0 < (O = f[d]) && 1 > O && l(Pn(n, i.x1, i.x2, i.x, O));
            for (var p = 0, m = Nn(r, i.y1, i.y2, i.y); p < m.length; p++)
              0 < (O = m[p]) && 1 > O && u(Pn(r, i.y1, i.y2, i.y, O));
          }
          if (i.type & K.ARC) {
            (l(i.x), u(i.y), On(i, n, r));
            for (
              var h = (i.xRot / 180) * Math.PI,
                g = Math.cos(h) * i.rX,
                _ = Math.sin(h) * i.rX,
                v = -Math.sin(h) * i.rY,
                y = Math.cos(h) * i.rY,
...
`
              ...
              if (
                ...
                if (
                  ...
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    (this.curArgs.push(c),
                      this.curArgs.length === Bn[this.curCommandType] &&
                        (K.HORIZ_LINE_TO === this.curCommandType
                          ? r({
                              type: K.HORIZ_LINE_TO,
                              relative: this.curCommandRelative,
                              x: c,
                            })
                          : K.VERT_LINE_TO === this.curCommandType
                            ? r({
                                type: K.VERT_LINE_TO,
                                relative: this.curCommandRelative,
                                y: c,
                              })
                            : this.curCommandType === K.MOVE_TO ||
                                this.curCommandType === K.LINE_TO ||
                                this.curCommandType === K.SMOOTH_QUAD_TO
                              ? (r({
                                ...
                                K.MOVE_TO === this.curCommandType &&
                                  (this.curCommandType = K.LINE_TO))
                              : this.curCommandType === K.CURVE_TO
                                ? r({
                                    type: K.CURVE_TO,
                                    relative: this.curCommandRelative,
                                    x1: this.curArgs[0],
                                ...
                                : this.curCommandType === K.SMOOTH_CURVE_TO
                                  ? r({
                    ...
                    if (a === `,` && this.canParseCommandOrComma)
                      ...
                      if (s)
                        ...
                        if (
                          ...
                          if (a === `h` || a === `H`)
                            ((this.curCommandType = K.HORIZ_LINE_TO),
                              (this.curCommandRelative = a === `h`));
                          else if (a === `v` || a === `V`)
                            ((this.curCommandType = K.VERT_LINE_TO),
                              (this.curCommandRelative = a === `v`));
                          else if (a === `m` || a === `M`)
                            ((this.curCommandType = K.MOVE_TO),
                              (this.curCommandRelative = a === `m`));
                          else if (a === `l` || a === `L`)
                            ((this.curCommandType = K.LINE_TO),
                              (this.curCommandRelative = a === `l`));
                          else if (a === `c` || a === `C`)
                            ((this.curCommandType = K.CURVE_TO),
                            ...
                            ((this.curCommandType = K.QUAD_TO),
                              (this.curCommandRelative = a === `q`));
                          else if (a === `t` || a === `T`)
                            ((this.curCommandType = K.SMOOTH_QUAD_TO),
                              (this.curCommandRelative = a === `t`));
                          else {
                            if (a !== `a` && a !== `A`)
                              throw SyntaxError(
                                `Unexpected character "` +
        ...
        return Object.create(this, {
          parse: {
            value: function (t, n) {
              n === void 0 && (n = []);
              for (
                var r = 0, i = Object.getPrototypeOf(this).parse.call(this, t);
                r < i.length;
                r++
              ) {
                var a = i[r],
  ...
  Bn =
    (((Fn = {})[K.MOVE_TO] = 2),
    (Fn[K.LINE_TO] = 2),
    (Fn[K.HORIZ_LINE_TO] = 1),
    (Fn[K.VERT_LINE_TO] = 1),
    (Fn[K.CLOSE_PATH] = 0),
    (Fn[K.QUAD_TO] = 4),
    (Fn[K.SMOOTH_QUAD_TO] = 2),
    (Fn[K.CURVE_TO] = 6),
    (Fn[K.SMOOTH_CURVE_TO] = 4),
    (Fn[K.ARC] = 7),
    Fn);
e(() => {
  var e = ae().PROPER,
...
function qn(e, t, n, r, i, a) {
  for (
    ...
    ((p = p.next = new Jn()), h === u && (m = p));
  p.next = f;
  for (
    var g = null, _ = null, v = 0, y = 0, b = Un[a], x = Wn[a], S = 0;
    S < i;
    S++
  ) {
    p = f;
    for (
      var C = o[y], w = o[y + 1], T = o[y + 2], E = o[y + 3], D = 0;
      D < u;
      D++
    )
      ((p.r = C), (p.g = w), (p.b = T), (p.a = E), (p = p.next));
    for (
      var O = 0,
        k = 0,
        A = 0,
  ...
  for (var he = 0; he < r; he++) {
    ...
    for (var Te = 0; Te < u; Te++)
      ((p.r = V), (p.g = ge), (p.b = _e), (p.a = H), (p = p.next));
...
var Zn = Object.freeze({ __proto__: null, offscreen: Yn, node: Xn });
function Qn(e) {
...
function ir(e) {
  ...
  var t = 3;
  return e.replace(/\d+(\.\d+)?/g, (e, n) =>
    t-- && n ? String(Math.round(parseFloat(e))) : e,
  );
}
var ar = /(\[[^\]]+\])/g,
  or = /(#[^\s+>~.[:]+)/g,
...
var J = class e {
  ...
  split() {
    var t =
        arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ` `,
      { document: n, name: r } = this;
    return Qn(this.getString())
      .trim()
      .split(t)
      .map((t) => new e(n, r, t));
  }
  ...
  getColor(e) {
    ...
    return this.isNormalizedColor
      ? t
      : ((this.isNormalizedColor = !0), (t = ir(t)), (this.value = t), t);
  }
  getDpi() {
    return 96;
  }
  ...
  getPixels(e) {
    ...
    var [n, r] = typeof e == `boolean` ? [void 0, e] : [e],
      { viewPort: i } = this.document.screen;
    switch (!0) {
      ...
      case this.isString(/%$/) && r:
        return this.getNumber() * this.getEm();
      case this.isString(/%$/):
        return this.getNumber() * i.computeSize(n);
      default:
    ...
    if (typeof n.createPattern == `function`) {
      if (n.getHrefAttribute().hasValue()) {
        ...
        ((n = n.getHrefAttribute().getDefinition()),
          r.hasValue() &&
            n.getAttribute(`patternTransform`, !0).setValue(r.value));
      }
  ...
  addOpacity(t) {
    for (
      var n = this.getColor(), r = n.length, i = 0, a = 0;
      a < r && (n[a] === `,` && i++, i !== 3);
      a++
    );
...
var Tr = class {
  ...
  Y = class e {
    ...
    static parsePath(t) {
      for (var n = q(t), r = n.length, i = [], a = 0; a < r; a += 2)
        i.push(new e(n[a], n[a + 1]));
      return i;
    }
    angleTo(e) {
  ...
  Er = class {
    ...
    start() {
      if (!this.working) {
        var { screen: e, onClick: t, onMouseMove: n } = this,
          r = e.ctx.canvas;
    ...
    runEvents() {
      if (this.working) {
        var { screen: e, events: t, eventElements: n } = this,
          { style: r } = e.ctx.canvas;
        (r && (r.cursor = ``),
          t.forEach((e, t) => {
    ...
    mapXY(e, t) {
      for (
        var { window: n, ctx: r } = this.screen, i = new Y(e, t), a = r.canvas;
        a;
      )
        ((i.x -= a.offsetLeft), (i.y -= a.offsetTop), (a = a.offsetParent));
      return (
        n.scrollX && (i.x += n.scrollX),
        n.scrollY && (i.y += n.scrollY),
        i
      );
    }
    onClick(e) {
  ...
  Or = typeof fetch < `u` ? fetch.bind(void 0) : null,
  kr = class {
    constructor(e) {
      var { fetch: t = Or, window: n = Dr } =
      ...
      ((this.ctx = e),
        ...
        (this.viewPort = new Tr()),
        (this.mouse = new Er(this)),
        (this.animations = []),
        (this.waits = []),
    ...
    setViewBox(e) {
      ...
      (v === `meet` && ((C *= x), (w *= x)),
        v === `slice` && ((C *= S), (w *= S)));
      var T = new J(t, `refX`, u),
        E = new J(t, `refY`, d),
        D = T.hasValue() && E.hasValue();
      ...
      if (!D) {
        var A = v === `meet` && x === b,
          ...
          M = v === `meet` && x === y,
          N = v === `slice` && S === y;
        (_.startsWith(`xMid`) && (A || j) && n.translate(i / 2 - C / 2, 0),
          _.endsWith(`YMid`) && (M || N) && n.translate(0, o / 2 - w / 2),
          _.startsWith(`xMax`) && (A || j) && n.translate(i - C, 0),
          _.endsWith(`YMax`) && (M || N) && n.translate(0, o - w));
      }
      switch (!0) {
        case _ === `none`:
          n.scale(y, b);
    ...
    start(e) {
      ...
      if (
        ...
        this.isReady() && this.render(e, i, a, s, c, l, u),
        t)
      ) {
        var m = Date.now(),
          h = m,
          ...
          _ = () => {
            ((m = Date.now()),
              ...
              g >= p &&
                ((h = m - (g % p)),
                this.shouldUpdate(r, o) &&
                  (this.render(e, i, a, s, c, l, u), f.runEvents())),
              (this.intervalId = (0, bn.default)(_)));
          };
        (n || f.start(), (this.intervalId = (0, bn.default)(_)));
      }
    }
    stop() {
      ((this.intervalId &&= (bn.default.cancel(this.intervalId), null)),
        this.mouse.stop());
    }
    shouldUpdate(e, t) {
      if (!e) {
    ...
    render(e, t, n, r, i, a, o) {
      ...
      (l.clear(),
        f.width && f.height
          ? l.setCurrent(f.width, f.height)
          : l.setCurrent(s, c));
      var p = e.getStyle(`width`),
        m = e.getStyle(`height`);
      !t &&
        (d || (typeof r != `number` && typeof i != `number`)) &&
        (p.hasValue() &&
          ((f.width = p.getPixels(`x`)),
          f.style && (f.style.width = `${f.width}px`)),
        m.hasValue() &&
          ((f.height = m.getPixels(`y`)),
          f.style && (f.style.height = `${f.height}px`)));
      var h = f.clientWidth || f.width,
        g = f.clientHeight || f.height;
      if (
        (t &&
          p.hasValue() &&
          m.hasValue() &&
          ((h = p.getPixels(`x`)), (g = m.getPixels(`y`))),
        l.setCurrent(h, g),
        typeof a == `number` && e.getAttribute(`x`, !0).setValue(a),
        typeof o == `number` && e.getAttribute(`y`, !0).setValue(o),
        typeof r == `number` || typeof i == `number`)
      ) {
        var _ = q(e.getAttribute(`viewBox`).getString()),
          v = 0,
          y = 0;
        if (typeof r == `number`) {
        ...
        ((v ||= y),
          (y ||= v),
          e.getAttribute(`width`, !0).setValue(r),
          e.getAttribute(`height`, !0).setValue(i));
        var S = e.getStyle(`transform`, !0, !0);
        S.setValue(`${S.getString()} scale(${1 / v}, ${1 / y})`);
      }
      (n || u.clearRect(0, 0, h, g),
        e.render(u),
        d && (this.isFirstRender = !1));
    }
  };
((kr.defaultWindow = Dr), (kr.defaultFetch = Or));
var { defaultFetch: Ar } = kr,
  jr = typeof DOMParser < `u` ? DOMParser : null,
  Mr = class {
    constructor() {
      var { fetch: e = Ar, DOMParser: t = jr } =
        arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  ...
  Pr = class {
    ...
    apply(e) {
      var { cx: t, cy: n, originX: r, originY: i, angle: a } = this,
        o = t + r.getPixels(`x`),
        s = n + i.getPixels(`y`);
  ...
  Ir = class {
    ...
    apply(e) {
      var { originX: t, originY: n, matrix: r } = this,
        i = t.getPixels(`x`),
        a = n.getPixels(`y`);
      (e.translate(i, a),
    ...
    unapply(e) {
      var { originX: t, originY: n, matrix: r } = this,
        ...
        f = 1,
        p =
          1 / (i * (c * f - l * d) - a * (s * f - l * u) + o * (s * d - c * u)),
        m = t.getPixels(`x`),
        h = n.getPixels(`y`);
      (e.translate(m, h),
        e.transform(
  ...
  constructor(t, n, r) {
    ((this.document = t),
      ...
      Br(n).forEach((t) => {
        if (t !== `none`) {
          var [n, i] = Vr(t),
            a = e.transformTypes[n];
          a !== void 0 && this.transforms.push(new a(this.document, i, r));
        }
      }));
  }
  static fromElement(t, n) {
    var r = n.getStyle(`transform`, !1, !0),
      [i, a = i] = n.getStyle(`transform-origin`, !1, !0).split(),
      o = [i, a];
    return r.hasValue() ? new e(t, r.getString(), o) : null;
  }
  apply(e) {
    for (var { transforms: t } = this, n = t.length, r = 0; r < n; r++)
      t[r].apply(e);
  }
  unapply(e) {
    for (var { transforms: t } = this, n = t.length - 1; n >= 0; n--)
      t[n].unapply(e);
  }
  applyToPoint(e) {
    for (var { transforms: t } = this, n = t.length, r = 0; r < n; r++)
...
var X = class e {
  constructor(e, t) {
    ...
    if (
      ...
      (i.hasValue() && (r[i.getString()] || (r[i.getString()] = this)),
  ...
  addChild(t) {
    ...
    ((n.parent = this),
      e.ignoreChildTypes.includes(n.type) || this.children.push(n));
  }
  matchesSelector(e) {
    var { node: t } = this;
      ...
      if (!n.startsWith(`@`) && this.matchesSelector(n)) {
        ...
        if (r)
          for (var a in r) {
            ...
            (o === void 0 && (o = `000`),
              i >= o &&
                ((this.styles[a] = r[a]), (this.stylesSpecificity[a] = i)));
          }
      }
  }
  removeStyles(e, t) {
...
var Jr = class e {
  constructor(t, n, r, i, a, o) {
    ...
    ((this.fontFamily = a || s.fontFamily),
      ...
      (this.fontVariant = n || s.fontVariant));
  }
  static parse() {
...
((Jr.styles = `normal|italic|oblique|inherit`),
  (Jr.variants = `normal|small-caps|inherit`),
  (Jr.weights = `normal|bold|bolder|lighter|100|200|300|400|500|600|700|800|900|inherit`));
var Yr = class {
    constructor() {
      var e =
    ...
    bezierCurveAdd(e, t, n, r, i) {
      ...
      if (o === 0) {
        ...
        0 < c &&
          c < 1 &&
          (e
            ? this.addX(this.sumCubic(c, t, n, r, i))
            : this.addY(this.sumCubic(c, t, n, r, i)));
        return;
      }
      var l = a ** 2 - 4 * s * o;
      if (!(l < 0)) {
        ...
        0 < u &&
          u < 1 &&
          (e
            ? this.addX(this.sumCubic(u, t, n, r, i))
            : this.addY(this.sumCubic(u, t, n, r, i)));
        var d = (-a - Math.sqrt(l)) / (2 * o);
        0 < d &&
          d < 1 &&
          (e
            ? this.addX(this.sumCubic(d, t, n, r, i))
            : this.addY(this.sumCubic(d, t, n, r, i)));
      }
    }
    addBezierCurve(e, t, n, r, i, a, o, s) {
      (this.addPoint(e, t),
        this.addPoint(o, s),
        this.bezierCurveAdd(!0, e, n, i, o),
        this.bezierCurveAdd(!1, t, r, a, s));
    }
  ...
  Z = class extends K {
    ...
    reset() {
      ((this.i = -1),
        (this.command = null),
        (this.previousCommand = null),
        (this.start = new Y(0, 0)),
        (this.control = new Y(0, 0)),
        (this.current = new Y(0, 0)),
        (this.points = []),
        (this.angles = []));
    }
    isEnd() {
    ...
    getPoint() {
      var e =
        ...
        n = new Y(this.command[e], this.command[t]);
    ...
    addMarker(e, t, n) {
      ...
      (n &&
        i.length > 0 &&
        !i[i.length - 1] &&
        (i[i.length - 1] = r[r.length - 1].angleTo(n)),
    ...
    getMarkerAngles() {
      for (var { angles: e } = this, t = e.length, n = 0; n < t; n++)
        if (!e[n]) {
          for (var r = n + 1; r < t; r++)
            if (e[r]) {
              e[n] = e[r];
  ...
  Xr = class extends X {
    ...
    setContext(e) {
      ...
      if (!t) {
        ...
        if (
          (r.hasValue() &&
            (e.fillStyle = new J(this.document, `fill`, e.fillStyle)
              .addOpacity(r)
              .getColor()),
          i.isUrlDefinition())
        ) {
          ...
          i.getString() === `currentColor` &&
            i.setValue(this.getStyle(`color`).getColor());
          var l = i.getString();
          l !== `inherit` &&
            (e.strokeStyle = l === `none` ? `rgba(0,0,0,0)` : l);
        }
        a.hasValue() &&
          (e.strokeStyle = new J(this.document, `stroke`, e.strokeStyle)
            .addOpacity(a)
            .getString());
        ...
        var d = this.getStyle(`stroke-linecap`),
          ...
          p = this.getStyle(`stroke-miterlimit`),
          m = this.getStyle(`stroke-dasharray`),
          h = this.getStyle(`stroke-dashoffset`);
        if (
          (d.hasValue() && (e.lineCap = d.getString()),
          f.hasValue() && (e.lineJoin = f.getString()),
          p.hasValue() && (e.miterLimit = p.getNumber()),
          m.hasValue() && m.getString() !== `none`)
        ) {
          var g = q(m.getString());
          e.setLineDash === void 0
            ? e.webkitLineDash === void 0
              ? e.mozDash !== void 0 &&
                !(g.length === 1 && g[0] === 0) &&
                (e.mozDash = g)
              : (e.webkitLineDash = g)
          ...
          e.lineDashOffset === void 0
            ? e.webkitLineDashOffset === void 0
              ? e.mozDashOffset !== void 0 && (e.mozDashOffset = _)
              : (e.webkitLineDashOffset = _)
            : (e.lineDashOffset = _);
        }
      }
      if (((this.modifiedEmSizeStack = !1), e.font !== void 0)) {
        var v = this.getStyle(`font`),
          y = this.getStyle(`font-style`),
          b = this.getStyle(`font-variant`),
          x = this.getStyle(`font-weight`),
          S = this.getStyle(`font-size`),
          C = this.getStyle(`font-family`),
          w = new Jr(
            y.getString(),
            b.getString(),
            x.getString(),
            S.hasValue() ? `${S.getPixels(!0)}px` : ``,
            C.getString(),
            Jr.parse(v.getString(), e.font),
          );
        (y.setValue(w.fontStyle),
          b.setValue(w.fontVariant),
          x.setValue(w.fontWeight),
          S.setValue(w.fontSize),
          C.setValue(w.fontFamily),
          (e.font = w.toString()),
          S.isPixels() &&
            ((this.document.emSize = S.getPixels()),
  ...
  Q = class e extends Xr {
    constructor(e, t, n) {
      (super(e, t, n),
        ...
        (this.pathParser = new Z(this.getAttribute(`d`).getString())));
    }
    path(e) {
    ...
    renderChildren(e) {
      ...
      if (n) {
        ...
        if (a.isUrlDefinition())
          for (var u = a.getDefinition(), d = 1; d < r; d++) {
            var [f, p] = n[d];
            u.render(e, f, p);
          }
    ...
    static pathL(e) {
      var { current: t } = e;
      return { current: t, point: e.getAsCurrentPoint() };
    }
    pathL(t, n) {
      var { pathParser: r } = this,
        { current: i, point: a } = e.pathL(r),
        { x: o, y: s } = a;
      (r.addMarker(a, i), n.addPoint(o, s), t && t.lineTo(o, s));
    }
    static pathH(e) {
      var { current: t, command: n } = e,
        r = new Y((n.relative ? t.x : 0) + n.x, t.y);
      return ((e.current = r), { current: t, point: r });
    }
    pathH(t, n) {
      var { pathParser: r } = this,
        { current: i, point: a } = e.pathH(r),
        { x: o, y: s } = a;
      (r.addMarker(a, i), n.addPoint(o, s), t && t.lineTo(o, s));
    }
    static pathV(e) {
      var { current: t, command: n } = e,
        r = new Y(t.x, (n.relative ? t.y : 0) + n.y);
      return ((e.current = r), { current: t, point: r });
    }
    pathV(t, n) {
      var { pathParser: r } = this,
        { current: i, point: a } = e.pathV(r),
        { x: o, y: s } = a;
      (r.addMarker(a, i), n.addPoint(o, s), t && t.lineTo(o, s));
    }
    static pathC(e) {
    ...
    pathC(t, n) {
      var { pathParser: r } = this,
        { current: i, point: a, controlPoint: o, currentPoint: s } = e.pathC(r);
      (r.addMarker(s, o, a),
        n.addBezierCurve(i.x, i.y, a.x, a.y, o.x, o.y, s.x, s.y),
    ...
    pathS(t, n) {
      var { pathParser: r } = this,
        { current: i, point: a, controlPoint: o, currentPoint: s } = e.pathS(r);
      (r.addMarker(s, o, a),
        n.addBezierCurve(i.x, i.y, a.x, a.y, o.x, o.y, s.x, s.y),
        t && t.bezierCurveTo(a.x, a.y, o.x, o.y, s.x, s.y));
    }
    ...
    pathQ(t, n) {
      var { pathParser: r } = this,
        { current: i, controlPoint: a, currentPoint: o } = e.pathQ(r);
      (r.addMarker(o, a, a),
        n.addQuadraticCurve(i.x, i.y, a.x, a.y, o.x, o.y),
        t && t.quadraticCurveTo(a.x, a.y, o.x, o.y));
    }
    static pathT(e) {
      var { current: t } = e,
        n = e.getReflectedControlPoint();
      return (
        (e.control = n),
        { current: t, controlPoint: n, currentPoint: e.getAsCurrentPoint() }
      );
    }
    pathT(t, n) {
      var { pathParser: r } = this,
        { current: i, controlPoint: a, currentPoint: o } = e.pathT(r);
      (r.addMarker(o, a, a),
        n.addQuadraticCurve(i.x, i.y, a.x, a.y, o.x, o.y),
        t && t.quadraticCurveTo(a.x, a.y, o.x, o.y));
    }
    static pathA(e) {
      var { current: t, command: n } = e,
        { rX: r, rY: i, xRot: a, lArcFlag: o, sweepFlag: s } = n,
        c = (Math.PI / 180) * a,
        l = e.getAsCurrentPoint(),
        u = new Y(
          (Math.cos(c) * (t.x - l.x)) / 2 + (Math.sin(c) * (t.y - l.y)) / 2,
          (-Math.sin(c) * (t.x - l.x)) / 2 + (Math.cos(c) * (t.y - l.y)) / 2,
        ),
        d = u.x ** 2 / r ** 2 + u.y ** 2 / i ** 2;
      d > 1 && ((r *= Math.sqrt(d)), (i *= Math.sqrt(d)));
      var f =
        (o === s ? -1 : 1) *
        Math.sqrt(
          (r ** 2 * i ** 2 - r ** 2 * u.y ** 2 - i ** 2 * u.x ** 2) /
            (r ** 2 * u.y ** 2 + i ** 2 * u.x ** 2),
        );
      isNaN(f) && (f = 0);
      var p = new Y((f * r * u.y) / i, (f * -i * u.x) / r),
        m = new Y(
          (t.x + l.x) / 2 + Math.cos(c) * p.x - Math.sin(c) * p.y,
          (t.y + l.y) / 2 + Math.sin(c) * p.x + Math.cos(c) * p.y,
        ),
        h = _r([1, 0], [(u.x - p.x) / r, (u.y - p.y) / i]),
        g = [(u.x - p.x) / r, (u.y - p.y) / i],
        _ = [(-u.x - p.x) / r, (-u.y - p.y) / i],
        v = _r(g, _);
      return (
        gr(g, _) <= -1 && (v = Math.PI),
        gr(g, _) >= 1 && (v = 0),
    ...
    pathA(t, n) {
      var { pathParser: r } = this,
        ...
        f = 1 - s ? 1 : -1,
        p = u + (d / 2) * f,
        m = new Y(l.x + a * Math.cos(p), l.y + o * Math.sin(p));
      if (
        (r.addMarkerAngle(m, p - (f * Math.PI) / 2),
        r.addMarkerAngle(i, p - f * Math.PI),
        n.addPoint(i.x, i.y),
        t && !isNaN(u) && !isNaN(d))
      ) {
        var h = a > o ? a : o,
    ...
    pathZ(t, n) {
      (e.pathZ(this.pathParser),
        t && n.x1 !== n.x2 && n.y1 !== n.y2 && t.closePath());
    }
  },
  Zr = class extends Q {
    constructor(e, t, n) {
  ...
  Qr = class e extends Xr {
    ...
    getFontSize() {
      var { document: e, parent: t } = this,
        n = Jr.parse(e.ctx.font).fontSize;
    ...
    getGlyph(e, t, n) {
      ...
      if (e.isArabic) {
        var a = t.length,
          ...
          c = `isolated`;
        if (
          ((n === 0 || o === ` `) && n < a - 1 && s !== ` ` && (c = `terminal`),
          n > 0 && o !== ` ` && n < a - 1 && s !== ` ` && (c = `medial`),
          n > 0 && o !== ` ` && (n === a - 1 || s === ` `) && (c = `initial`),
          e.glyphs[r] !== void 0)
        ) {
          var l = e.glyphs[r];
    ...
    renderTElementChildren(e) {
      var { document: t, parent: n } = this,
        r = this.getText(),
        i = n.getStyle(`font-family`).getDefinition();
      if (i) {
        for (
          var { unitsPerEm: a } = i.fontFace,
            o = Jr.parse(t.ctx.font),
            s = n.getStyle(`font-size`).getNumber(o.fontSize),
            c = n.getStyle(`font-style`).getString(o.fontStyle),
            l = s / a,
            u = i.isRTL ? r.split(``).reverse().join(``) : r,
            d = q(n.getAttribute(`dx`).getString()),
            f = u.length,
            p = 0;
          p < f;
          p++
          ...
          var h = e.lineWidth;
          ((e.lineWidth = (e.lineWidth * a) / s),
            c === `italic` && e.transform(1, 0, 0.4, 1, 0, 0),
            m.render(e),
            c === `italic` && e.transform(1, 0, -0.4, 1, 0, 0),
            (e.lineWidth = h),
            e.scale(1 / l, -1 / l),
            e.translate(-this.x, -this.y),
            (this.x += (s * (m.horizAdvX || i.horizAdvX)) / a),
            d[p] !== void 0 && !isNaN(d[p]) && (this.x += d[p]));
        }
        return;
      }
      var { x: g, y: _ } = this;
      (e.fillStyle && e.fillText(r, g, _),
        e.strokeStyle && e.strokeText(r, g, _));
    }
    applyAnchoring() {
    ...
    adjustChildCoordinates(e, t, n, r) {
      ...
      var a = i.getAttribute(`x`),
        ...
        s = i.getAttribute(`dx`),
        c = i.getAttribute(`dy`),
        l = i.getStyle(`font-family`).getDefinition(),
        u = !!l && l.isRTL;
      r === 0 &&
        ...
        c.hasValue() || c.setValue(i.getInheritedAttribute(`dy`)));
      ...
      return (
        ...
        a.hasValue()
          ...
          : (s.hasValue() && (t.x += s.getPixels(`x`)), (i.x = t.x)),
        (t.x = i.x),
        u || (t.x += d),
        o.hasValue()
          ? ((i.y = o.getPixels(`y`)),
            c.hasValue() && (i.y += c.getPixels(`y`)))
          : (c.hasValue() && (t.y += c.getPixels(`y`)), (i.y = t.y)),
        (t.y = i.y),
        t.leafTexts.push(i),
        (t.minX = Math.min(t.minX, i.x, i.x + d)),
        (t.maxX = Math.max(t.maxX, i.x, i.x + d)),
        i.clearContext(e),
        e.restore(),
        i
      );
      ...
      if (r) {
        for (
          var i = this.getFontSize(),
            a = r.isRTL ? t.split(``).reverse().join(``) : t,
            o = q(n.getAttribute(`dx`).getString()),
            s = a.length,
            c = 0,
            l = 0;
          l < s;
          ...
          ((c += ((u.horizAdvX || r.horizAdvX) * i) / r.fontFace.unitsPerEm),
            o[l] !== void 0 && !isNaN(o[l]) && (c += o[l]));
        }
        return c;
      }
  ...
  ti = class extends Xr {
    ...
    setContext(e) {
      ...
      if (
        (n.setDefaults(e),
        i.style && e.font !== void 0 && r && r.getComputedStyle !== void 0)
      ) {
        e.font = r.getComputedStyle(i).getPropertyValue(`font`);
        var a = new J(t, `fontSize`, Jr.parse(e.font).fontSize);
        a.hasValue() &&
          ((t.rootEmSize = a.getPixels(`y`)), (t.emSize = t.rootEmSize));
      }
      ...
      var c = this.getAttribute(`refX`),
        ...
        d = u.hasValue() ? q(u.getString()) : null,
        f =
          !this.root &&
      ...
      (d && ((p = d[0]), (m = d[1])),
        this.root ||
          ...
          this.type === `marker` && ((h = p), (g = m), (p = 0), (m = 0))),
        n.viewPort.setCurrent(o, s),
        this.node &&
          (!this.parent ||
    ...
    resize(e) {
      ...
      if (
        (r.setValue(e),
        i.setValue(t),
        a.hasValue() || a.setValue(`0 0 ${s || e} ${c || t}`),
        o.hasValue())
      ) {
        var u = this.getStyle(`width`),
          d = this.getStyle(`height`);
        (u.hasValue() && u.setValue(`${e}px`),
          d.hasValue() && d.setValue(`${t}px`));
      }
    }
  },
  ni = class extends Q {
    ...
    path(e) {
      var t = this.getAttribute(`x`).getPixels(`x`),
        ...
        c = o.getPixels(`y`);
      if (
        (a.hasValue() && !o.hasValue() && (c = s),
        o.hasValue() && !a.hasValue() && (s = c),
        (s = Math.min(s, r / 2)),
        (c = Math.min(c, i / 2)),
        e)
      ) {
        ...
        (e.beginPath(),
          i > 0 &&
            ...
            e.lineTo(t, n + c),
            e.bezierCurveTo(t, n + c - l * c, t + s - l * s, n, t + s, n),
            e.closePath()));
      }
  ...
  ri = class extends Q {
    ...
    path(e) {
      ...
      return (
        e &&
          r > 0 &&
          (e.beginPath(), e.arc(t, n, r, 0, Math.PI * 2, !1), e.closePath()),
        new Yr(t - r, n - r, t + r, n + r)
      );
    }
    getMarkers() {
      return null;
    ...
    path(e) {
      ...
      return (
        e &&
          ...
          (e.beginPath(),
          e.moveTo(i + n, a),
          e.bezierCurveTo(i + n, a + t * r, i + t * n, a + r, i, a + r),
          e.bezierCurveTo(i - t * n, a + r, i - n, a + t * r, i - n, a),
          e.bezierCurveTo(i - n, a - t * r, i - t * n, a - r, i, a - r),
          e.bezierCurveTo(i + t * n, a - r, i + n, a - t * r, i + n, a),
          e.closePath()),
        new Yr(i - n, a - r, i + n, a + r)
      );
    }
    getMarkers() {
      return null;
  ...
  ai = class extends Q {
    ...
    path(e) {
      ...
      return (
        e && (e.beginPath(), e.moveTo(t, n), e.lineTo(r, i)),
        new Yr(t, n, r, i)
      );
    }
    getMarkers() {
  ...
  oi = class extends Q {
    constructor(e, t, n) {
      (super(e, t, n),
        (this.type = `polyline`),
        (this.points = []),
        (this.points = Y.parsePath(this.getAttribute(`points`).getString())));
    }
    path(e) {
      var { points: t } = this,
        [{ x: n, y: r }] = t,
  ...
  ci = class extends X {
    ...
    createPattern(e, t, n) {
      var r = this.getStyle(`width`).getPixels(`x`, !0),
        ...
        a = new ti(this.document, null);
      ((a.attributes.viewBox = new J(
        this.document,
        `viewBox`,
        this.getAttribute(`viewBox`).getValue(),
      )),
        (a.attributes.width = new J(this.document, `width`, `${r}px`)),
        (a.attributes.height = new J(this.document, `height`, `${i}px`)),
        (a.attributes.transform = new J(
          this.document,
          `transform`,
          this.getAttribute(`patternTransform`).getValue(),
        )),
        (a.children = this.children));
      var o = this.document.createCanvas(r, i),
        s = o.getContext(`2d`),
        c = this.getAttribute(`x`),
        l = this.getAttribute(`y`);
      (c.hasValue() &&
        l.hasValue() &&
        s.translate(c.getPixels(`x`, !0), l.getPixels(`y`, !0)),
        n.hasValue()
          ? (this.styles[`fill-opacity`] = n)
          : Reflect.deleteProperty(this.styles, `fill-opacity`));
      for (var u = -1; u <= 1; u++)
        for (var d = -1; d <= 1; d++)
          (s.save(),
            (a.attributes.x = new J(this.document, `x`, u * o.width)),
            (a.attributes.y = new J(this.document, `y`, d * o.height)),
            a.render(s),
            s.restore());
  ...
  di = class extends Xr {
    ...
    createGradient(e, t, n) {
      ...
      if (
        ...
        var { document: o } = this,
          { MAX_VIRTUAL_PIXELS: s, viewPort: c } = o.screen,
          [l] = c.viewPorts,
          u = new ni(o, null);
        ((u.attributes.x = new J(o, `x`, -s / 3)),
          (u.attributes.y = new J(o, `y`, -s / 3)),
          (u.attributes.width = new J(o, `width`, s)),
          (u.attributes.height = new J(o, `height`, s)));
        var d = new di(o, null);
        ((d.attributes.transform = new J(
          o,
          `transform`,
          ...
          (d.children = [u]));
        var f = new ti(o, null);
        ((f.attributes.x = new J(o, `x`, 0)),
          (f.attributes.y = new J(o, `y`, 0)),
          (f.attributes.width = new J(o, `width`, l.width)),
          (f.attributes.height = new J(o, `height`, l.height)),
          (f.children = [d]));
        var p = o.createCanvas(l.width, l.height),
          m = p.getContext(`2d`);
        return (
          (m.fillStyle = a),
          f.render(m),
          m.createPattern(p, `no-repeat`)
        );
      }
      return a;
    }
    ...
    addParentOpacity(e, t) {
      return e.hasValue()
        ? new J(this.document, `color`, t).addOpacity(e).getColor()
        : t;
    }
  },
  pi = class extends fi {
    ...
    getGradient(e, t) {
      var n = this.getGradientUnits() === `objectBoundingBox`,
        r = n ? t.getBoundingBox(e) : null;
      if (n && !r) return null;
  ...
  hi = class extends X {
    constructor(e, t, n) {
      ...
      var r = Math.max(0, Math.min(1, this.getAttribute(`offset`).getNumber())),
        i = this.getStyle(`stop-opacity`),
        a = this.getStyle(`stop-color`, !0);
      (a.getString() === `` && a.setValue(`#000`),
        i.hasValue() && (a = a.addOpacity(i)),
        (this.offset = r),
  ...
  gi = class extends X {
    constructor(e, t, n) {
      (super(e, t, n),
        ...
        (this.values = new J(e, `values`, null)));
    ...
    calcValue() {
      var { initialUnits: e } = this,
        { progress: t, from: n, to: r } = this.getProgress(),
        i = n.getNumber() + (r.getNumber() - n.getNumber()) * t;
      return (e === `%` && (i *= 100), `${i}${e}`);
    }
    update(e) {
      var { parent: t } = this,
      ...
      if (
        (this.initialValue ||
          ((this.initialValue = n.getString()),
          (this.initialUnits = n.getUnits())),
        ...
        if (
          ...
          ((this.frozen = !0),
            (t.animationFrozen = !0),
            (t.animationFrozenValue = n.getString()));
    ...
    getProgress() {
      ...
      if (t.hasValue()) {
        var r = n.progress * (t.getValue().length - 1),
          i = Math.floor(r),
          a = Math.ceil(r);
        ((n.from = new J(e, `from`, parseFloat(t.getValue()[i]))),
          (n.to = new J(e, `to`, parseFloat(t.getValue()[a]))),
          (n.progress = (r - i) / (a - i)));
  ...
  _i = class extends gi {
    ...
    calcValue() {
      var { progress: e, from: t, to: n } = this.getProgress(),
        r = new xn.default(t.getColor()),
        i = new xn.default(n.getColor());
      if (r.ok && i.ok) {
        var a = r.r + (i.r - r.r) * e,
          o = r.g + (i.g - r.g) * e,
          s = r.b + (i.b - r.b) * e;
  ...
  Ci = class extends Qr {
    constructor(e, t, n) {
      ...
      var { childNodes: r } = t,
        i = r[0],
        a = r.length > 0 && Array.from(r).every((e) => e.nodeType === 3);
    ...
    renderChildren(e) {
      if (this.hasText) {
        ...
        var { document: t, x: n, y: r } = this,
          { mouse: i } = t.screen,
          a = new J(t, `fontSize`, Jr.parse(t.ctx.font).fontSize);
        i.isWorking() &&
          i.checkBoundingBox(
            this,
            new Yr(n, r - a.getPixels(`y`), n + this.measureText(e), r),
          );
...
var Ei = class extends Qr {
      ...
      (t === `underline` && e.beginPath(),
        r.forEach((r, i) => {
          ...
          (e.save(),
            ...
            e.restore(),
            t === `underline` &&
              (i === 0 && e.moveTo(a.x, a.y + n / 8),
              e.lineTo(o.x, o.y + n / 5)));
        }),
        t === `underline` &&
          ((e.lineWidth = n / 20),
          (e.strokeStyle = i),
    ...
    findSegmentToFitChar(e, t, n, r, i, a, o, s, c) {
      var l = a,
        u = this.measureText(e, s);
      (s === ` ` && t === `justify` && n < r && (u += (r - n) / i),
        c > -1 && (l += this.getLetterSpacingAt(c)));
      var d = this.textHeight / 20,
        f = this.getEquidistantPointOnPath(l, d, 0),
        p = this.getEquidistantPointOnPath(l + u, d, 0),
        m = { p0: f, p1: p },
        h = f && p ? Math.atan2(p.y - f.y, p.x - f.x) : 0;
      if (o) {
        var g = Math.cos(Math.PI / 2 + h) * o,
          _ = Math.cos(-h) * o;
        ((m.p0 = Ti(Ti({}, f), {}, { x: f.x + g, y: f.y + _ })),
          (m.p1 = Ti(Ti({}, p), {}, { x: p.x + g, y: p.y + _ })));
      }
      return ((l += u), { offset: l, segment: m, rotation: h });
    }
    measureText(e, t) {
      var { measuresCache: n } = this,
        r = t || this.getText();
    ...
    setTextData(e) {
      if (!this.glyphInfo) {
        var t = this.getText(),
          ...
          s = this.getStyle(`letter-spacing`),
          c = this.parent.getStyle(`letter-spacing`),
          l = 0;
        !s.hasValue() || s.getValue() === `inherit`
          ? (l = c.getPixels())
          : s.hasValue() &&
            s.getValue() !== `initial` &&
            s.getValue() !== `unset` &&
        ...
        var p = u.reduce((e, t, n) => (n === 0 ? 0 : e + t || 0), 0),
          m = this.measureText(e),
          h = Math.max(m + p, 0);
        ((this.textWidth = m),
          (this.textHeight = this.getFontSize()),
          (this.glyphInfo = []));
        var g = this.getPathLength(),
          _ = this.getStyle(`startOffset`).getNumber(0) * g,
          v = 0;
        ((o === `middle` || o === `center`) && (v = -h / 2),
          (o === `end` || o === `right`) && (v = -h),
          (v += _),
          n.forEach((t, i) => {
            var {
              ...
              segment: c,
              rotation: l,
            } = this.findSegmentToFitChar(e, o, h, g, r, v, a, t, i);
            ((v = s),
              !(!c.p0 || !c.p1) &&
                this.glyphInfo.push({
                  text: n[i],
    ...
    parsePathData(e) {
      ...
      for (n.reset(); !n.isEnd();) {
        ...
        o.type === Z.CLOSE_PATH
          ? t.push({ type: Z.CLOSE_PATH, points: [], pathLength: 0 })
          : t.push({
              type: s,
              points: c,
              start: { x: i, y: a },
    ...
    calcLength(e, t, n, r) {
      ...
      switch (n) {
        case Z.LINE_TO:
          return this.getLineLength(e, t, r[0], r[1]);
        case Z.CURVE_TO:
          for (
            i = 0,
        ...
        case Z.ARC:
          ...
          var c = r[4],
            ...
            d = Math.PI / 180;
          if (
            (Math.abs(c - u) < d && (d = Math.abs(c - u)),
            (a = this.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], c, 0)),
            l < 0)
          )
            for (s = c - d; s > u; s -= d)
              ((o = this.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], s, 0)),
                (i += this.getLineLength(a.x, a.y, o.x, o.y)),
                (a = o));
          else
            for (s = c + d; s < u; s += d)
              ((o = this.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], s, 0)),
                ...
                (a = o));
          return (
            (o = this.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], u, 0)),
            (i += this.getLineLength(a.x, a.y, o.x, o.y)),
            i
          );
      }
    ...
    getPointOnLine(e, t, n, r, i) {
      var a =
          arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : t,
        o = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : n,
        s = (i - n) / (r - t + mr),
        c = Math.sqrt((e * e) / (1 + s * s));
      r < t && (c *= -1);
      var l = s * c,
        u = null;
      if (r === t) u = { x: a, y: o + l };
      else if ((o - n) / (a - t + 1e-8) === s) u = { x: a + c, y: o + l };
      else {
        var d = 0,
          f = 0,
          p = this.getLineLength(t, n, r, i);
        if (p < 1e-8) return null;
        var m = (a - t) * (r - t) + (o - n) * (i - n);
        ((m /= p * p), (d = t + m * (r - t)), (f = n + m * (i - n)));
        var h = this.getLineLength(a, o, d, f),
          g = Math.sqrt(e * e - h * h);
        ((c = Math.sqrt((g * g) / (1 + s * s))),
          r < t && (c *= -1),
          (l = s * c),
          (u = { x: d + c, y: f + l }));
      }
    ...
    getPointOnEllipticalArc(e, t, n, r, i, a) {
      var o = Math.cos(a),
        s = Math.sin(a),
        c = { x: n * Math.cos(i), y: r * Math.sin(i) };
      return { x: e + (c.x * o - c.y * s), y: t + (c.x * s + c.y * o) };
    }
    buildEquidistantCache(e, t) {
      ...
      if (
        ...
        this.equidistantCache = { step: i, precision: r, points: [] };
        for (var a = 0, o = 0; o <= n; o += r) {
          var s = this.getPointOnPath(o),
            c = this.getPointOnPath(o + r);
          !s ||
            !c ||
            ((a += this.getLineLength(s.x, s.y, c.x, c.y)),
            a >= i &&
    ...
    getEquidistantPointOnPath(e, t, n) {
      if (
        (this.buildEquidistantCache(t, n),
  ...
  Oi = class extends Xr {
    constructor(e, t, n) {
      ...
      if (r) {
        ...
        (e.images.push(this),
          i ? this.loadSvg(r) : this.loadImage(r),
          (this.isSvg = i));
      }
    }
    loadImage(e) {
    ...
    renderChildren(e) {
      var { document: t, image: n, loaded: r } = this,
  ...
  Ai = class {
    ...
    load(e, t) {
      ...
      return yt(function* () {
        try {
          var { document: r } = n,
            i = (yield r.canvg.parser.load(t)).getElementsByTagName(`font`);
                ...
                if (n) {
                  ...
                  if (
                    (a.forEach((t) => {
                      var n = t.indexOf(`:`),
                        i = t.substr(0, n).trim(),
                        a = t.substr(n + 1, t.length - n).trim();
                      i && a && (r[i] = new J(e, i, a));
                    }),
                    (e.styles[n] = r),
                    (e.stylesSpecificity[n] = pr(n)),
                    n === `@font-face`)
                  ) {
...
var Mi = class extends Xr {
  ...
  setContext(e) {
    ...
    (t.hasValue() && e.translate(t.getPixels(`x`), 0),
      n.hasValue() && e.translate(0, n.getPixels(`y`)));
  }
  path(e) {
    var { element: t } = this;
    t && t.path(e);
  ...
  renderChildren(e) {
    ...
    if (n) {
      ...
      if (
        (n.type === `symbol` &&
          ((r = new ti(t, null)),
          (r.attributes.viewBox = new J(
            t,
            `viewBox`,
            n.getAttribute(`viewBox`).getString(),
          )),
          (r.attributes.preserveAspectRatio = new J(
            t,
            `preserveAspectRatio`,
            n.getAttribute(`preserveAspectRatio`).getString(),
          )),
          (r.attributes.overflow = new J(
            t,
            `overflow`,
            n.getAttribute(`overflow`).getString(),
          )),
          (r.children = n.children),
          (n.styles.opacity = new J(t, `opacity`, this.calculateOpacity()))),
        r.type === `svg`)
      ) {
        var i = this.getStyle(`width`, !1, !0),
          a = this.getStyle(`height`, !1, !0);
        (i.hasValue() &&
          (r.attributes.width = new J(t, `width`, i.getString())),
          a.hasValue() &&
            (r.attributes.height = new J(t, `height`, a.getString())));
      }
      var o = r.parent;
...
var Ii = class extends X {
    constructor(e, t, n) {
      ...
      switch (this.getAttribute(`type`).getString(`matrix`)) {
        ...
        case `hueRotate`:
          ...
          r = [
            Fi(a, 0.213, 0.787, -0.213),
            Fi(a, 0.715, -0.715, -0.715),
            Fi(a, 0.072, -0.072, 0.928),
            0,
            0,
            Fi(a, 0.213, -0.213, 0.143),
            Fi(a, 0.715, 0.285, 0.14),
            Fi(a, 0.072, -0.072, -0.283),
            0,
            0,
            Fi(a, 0.213, -0.213, -0.787),
            Fi(a, 0.715, -0.715, 0.715),
            Fi(a, 0.072, 0.928, 0.072),
            0,
            0,
            0,
            0,
    ...
    apply(e, t, n, r, i) {
      for (
        var { includeOpacity: a, matrix: o } = this,
          s = e.getImageData(0, 0, r, i),
          c = 0;
        c < i;
        c++
      )
        for (var l = 0; l < r; l++) {
          var u = Ni(s.data, l, c, r, i, 0),
            d = Ni(s.data, l, c, r, i, 1),
            f = Ni(s.data, l, c, r, i, 2),
            p = Ni(s.data, l, c, r, i, 3),
            m = $(o, 0, u) + $(o, 1, d) + $(o, 2, f) + $(o, 3, p) + $(o, 4, 1),
            h = $(o, 5, u) + $(o, 6, d) + $(o, 7, f) + $(o, 8, p) + $(o, 9, 1),
            g =
              $(o, 10, u) +
              $(o, 11, d) +
              $(o, 12, f) +
            ...
            _ =
              ...
              $(o, 18, p) +
              $(o, 19, 1);
          (a && ((m = 0), (h = 0), (g = 0), (_ *= p / 255)),
            Pi(s.data, l, c, r, i, 0, m),
            Pi(s.data, l, c, r, i, 1, h),
            Pi(s.data, l, c, r, i, 2, g),
            Pi(s.data, l, c, r, i, 3, _));
        }
    ...
    apply(t, n) {
      ...
      if (!o && !s) {
        ...
        (this.children.forEach((e) => {
          ...
          (s = Math.floor(c.height)));
      }
      var l = this.removeStyles(n, e.ignoreStyles),
        u = r.createCanvas(i + o, a + s),
        d = u.getContext(`2d`);
      ...
      var f = r.createCanvas(i + o, a + s),
        p = f.getContext(`2d`);
      (r.screen.setDefaults(p),
        n.render(p),
        (p.globalCompositeOperation = `destination-in`),
        (p.fillStyle = d.createPattern(u, `no-repeat`)),
        p.fillRect(0, 0, i + o, a + s),
        (t.fillStyle = p.createPattern(f, `no-repeat`)),
        t.fillRect(0, 0, i + o, a + s),
        this.restoreStyles(n, l));
    }
    render(e) {}
  };
Li.ignoreStyles = [`mask`, `transform`, `clip-path`];
var Ri = () => {},
  zi = class extends X {
    constructor() {
    ...
    apply(e) {
      var { document: t } = this,
        ...
        { beginPath: r, closePath: i } = e;
      (n && ((n.beginPath = Ri), (n.closePath = Ri)),
        Reflect.apply(r, e, []),
        this.children.forEach((r) => {
          if (r.path !== void 0) {
            var a = r.elementTransform === void 0 ? null : r.elementTransform();
            ((a ||= Hr.fromElement(t, r)),
              a && a.apply(e),
              r.path(e),
              n && (n.closePath = i),
              a && a.unapply(e));
      ...
      if (a) {
        ...
        if (!(u < 1 || d < 1)) {
          var f = Math.floor(a.x),
            p = Math.floor(a.y),
            m = this.removeStyles(n, e.ignoreStyles),
            h = r.createCanvas(u, d),
            g = h.getContext(`2d`);
          (r.screen.setDefaults(g),
            ...
            t.drawImage(h, 0, 0, u, d, f - o, p - s, u, d),
            this.restoreStyles(n, m));
        }
      }
    }
    render(e) {}
  };
Bi.ignoreStyles = [`filter`, `transform`, `clip-path`];
var Vi = class extends X {
  ...
  Wi = class extends X {
    ...
    apply(e, t, n, r, i) {
      var { document: a, blurRadius: o } = this,
        s = a.window ? a.window.document.body : null,
        c = e.canvas;
      ((c.id = a.getUniqueId()),
        s && ((c.style.display = `none`), s.appendChild(c)),
        Kn(c, t, n, r, i, o),
        s && s.removeChild(c));
    }
  },
...
var na = class e {
  constructor(e, t) {
    var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    ((this.parser = new Mr(n)),
      (this.screen = new kr(e, n)),
      (this.options = n));
    var r = new $i(this, n),
      i = r.createDocumentElement(t);
  ...
  static from(t, n) {
    ...
    return yt(function* () {
      var i = r.length > 2 && r[2] !== void 0 ? r[2] : {},
        a = yield new Mr(i).parse(n);
      return new e(t, a, i);
    })();
  }
  static fromString(t, n) {
    var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
      i = new Mr(r).parseFromString(n);
    return new e(t, i, r);
  }
  fork(t, n) {
    var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  render() {
    ...
    return yt(function* () {
      ...
      (t.start(
        ta({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, n),
      ),
        yield t.ready(),
        t.stop());
    })();
  ...
  start() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      { documentElement: t, screen: n, options: r } = this;
